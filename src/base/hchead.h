...
#define  MSG_YJ_PC                      6
#define  MSG_YJ_SN                      7
#define  MSG_YJ_START                   8
#define  MSG_YJ_STOP                    9
#define  MSG_YJ_INFO                    10
#define  MSG_YJ_DATA                    11
#define  MSG_YJ_HEALTH                  12
...
#define  CICRLE_MAX_4000_55HZ           742  // 5.5hz
#define  CICRLE_MAX_4000_7HZ            586  // 7hz

#define  SPEED_480_NOR                  480
...
#define  SPEED_420_MAX                  (SPEED_420_NOR+SPEED_420_RANGE)
#define  SPEED_420_MIN                  (SPEED_420_NOR-SPEED_420_RANGE)
#define  SPEED_330_MAX                  (SPEED_330_NOR+SPEED_330_RANGE)
#define  SPEED_330_MIN                  (SPEED_330_NOR-SPEED_330_RANGE)
#define  SPEED_480_MAX                  (SPEED_480_NOR+SPEED_420_RANGE)
#define  SPEED_480_MIN                  (SPEED_480_NOR-SPEED_420_RANGE)
...
typedef struct tsPointCloudHeadYJ
{
	UINT16       u16Head;
	UCHAR        u8Info;
	UCHAR        u8Num;	
...
typedef struct tsHealthMessage
{
	UINT16       u16Head;
	UCHAR        u8Info;
	UCHAR        u8Len;
...
typedef struct tsPointCloudTailYJ
{
	UINT64       u16TS;
}tsPointCloudTailYJ;
